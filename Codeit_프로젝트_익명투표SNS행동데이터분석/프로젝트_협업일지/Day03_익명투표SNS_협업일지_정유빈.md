...
- 유저수는 많지만, 실제로 활동한 유저 수는 **극히 적은 것으로 보여졌음**  
  ...
  ![1760495251299](<image/Day3_협업일지_정유빈/1760495251299.png>)

<BR>

- 임시 `user_info` 각 컬럼의 NULL 개수
  ![1760495379795](<image/Day3_협업일지_정유빈/1760495379795.png>)
...
- 그래서 `accounts_user` 테이블을 제외한 **나머지 테이블에서 중복없이 `user_id` 정보를 가져온 후 `accounts_user`에서 필요한 데이터만 가져오기**
  ...
  ![1760496149048](<image/Day3_협업일지_정유빈/1760496149048.png>)
...
![1760514571478](<image/Day3_협업일지_정유빈/1760514571478.png>)
